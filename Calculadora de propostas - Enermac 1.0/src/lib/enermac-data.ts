...
export const GERADORES: Gerador[] = [
  { 
    ...
    potencia_kw: 75, 
    consumo_nm3h: 52,            // Consumo de biogás em Nm³/h
    fator_conversao: 1.35,       // kWh por Nm³ de biogás
    preco_kit: 191251.65         // Preço de VENDA sem crédito ICMS
  },
  { 
    id: 'g108', 
    ...
    consumo_nm3h: 75,
    fator_conversao: 1.35,       // kWh por Nm³ de biogás
    preco_kit: 217896.30         // Preço de VENDA sem crédito ICMS
  },
  { 
    id: 'g260', 
    ...
    potencia_kw: 260, 
    consumo_nm3h: 180,
    fator_conversao: 1.40,       // kWh por Nm³ de biogás
    preco_kit: 758230.03         // Preço de VENDA sem crédito ICMS
  },
];
...
export const MANUTENCAO_PADRAO: ParametrosManutencao = {
  custoKm: 2.50,
  distanciaKm: 100,
  custoHoraGerador: 8.00,
  frequenciaMensal: 1,
  horasTecnicasVisita: 8,
  custoHoraTecnico: 80.00,
