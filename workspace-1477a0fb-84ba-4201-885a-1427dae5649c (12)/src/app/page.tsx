                              ...
                              <div key={`sem-${cenario.nome}`} className={`${cores.bg} rounded-lg p-4 border ${cores.border}`}>
                                ...
                                <div className="space-y-3 text-sm">
                                  ...
                                  <div className="bg-gray-100 rounded p-2 mt-2">
                                    ...
                                    {/* Average monthly net result */}
                                    <div className="flex justify-between border-t pt-1 mt-1 bg-green-50 -mx-2 px-2 py-1 rounded">
                                      <span className="text-xs text-gray-600">Resultado líquido médio mensal</span>
                                      <span className={`text-xs font-semibold ${cenario.resultadoLiquidoMedioMensal >= 0 ? 'text-green-700' : 'text-red-700'}`}>
                                        {formatarMoeda(cenario.resultadoLiquidoMedioMensal)}
                                      </span>
                                    </div>
